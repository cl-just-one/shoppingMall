						...
						<div class="addr-list">
							<ul>
								<li
									...
									:key="item.addressId"
									:class="{'check':checkIndex==idx}"
									@click="checkIndex=idx;checkedId=item.addressId">
									<dl>
										<dt>{{item.userName}}</dt>
									...
									<div class="addr-opration addr-del">
										<a href="javascript:;" class="addr-del-btn" @click="modalConfirm(item.addressId)">
	...
	export default {
      ...
      NavBread,
		...
		methods: {
			...
			modalConfirm(addressId) {
				this.isMdShow = true
				this.addressId = addressId
			},
			delAddress() {
				axios.post('/users/delAddres', {
