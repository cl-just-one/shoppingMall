<template>
  <div>
    ...
    <modal :mdShow="mdCartConfirm" @close="closeModal">
      <p slot="message">你确定删除此条数据?</p>
      <div slot="btnGroup">
        <a class="btn btn--m" href="javascript:;" @click="cartDel">确定</a>
        <a class="btn btn--m" href="javascript:;" @click="mdCartConfirm=false">关闭</a>
      </div>
    </modal>
